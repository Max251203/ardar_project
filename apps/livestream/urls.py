...
urlpatterns = [
    ...
    # Управление правами на микрофон/камеру
    ...
    path('lower_hand/<int:room_id>/<int:user_id>/', views.livestream_lower_hand,
         name='livestream_lower_hand_user'),

    # Отмена ожидания
    path('cancel_waiting/<int:room_id>/', views.livestream_cancel_waiting,
         name='livestream_cancel_waiting'),

    # Получить список заявок (для ведущего)
